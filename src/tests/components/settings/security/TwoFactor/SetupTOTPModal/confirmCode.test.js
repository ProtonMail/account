...
describe('SetupTOTPModal confirmCode step', () => {
    ...
    test('receiving status success', () => {
        const { tree, onSubmit } = updateTreeStatus({ status: 'success' });
    ...
    test('receiving status failure and no error', () => {
        const { tree, onReset } = updateTreeStatus({ status: 'failure' });
    ...
    test('receiving status failure and text error', () => {
        ...
        const { tree, onReset } = updateTreeStatus({ status: 'failure', error: errorMessage });
    ...
    test('receiving status failure native error', () => {
        const errorMessage = 'This is the error message';
        const { tree, onReset } = updateTreeStatus({ status: 'failure', error: new Error(errorMessage) });
    ...
    test('receiving props without status', () => {
        ...
        tree.render(<ConfirmCode settings={{}} onSubmit={onSubmit} onReset={onReset} />);
